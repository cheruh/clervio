      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-lg shadow-sm border p-6 mb-8">
            ...
            <p className="mb-4">
              We are building a behavioral intelligence platform that goes beyond traditional analytics by measuring the depth of human interaction — capturing the cognitive, emotional, and behavioral signals that reveal true user intent and experience.
            </p>
            <p>
          ...
          <div className="bg-card rounded-lg shadow-sm border p-6 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              We are always looking for talented individuals who are passionate about understanding human behavior and creating better digital experiences.
            </p>
